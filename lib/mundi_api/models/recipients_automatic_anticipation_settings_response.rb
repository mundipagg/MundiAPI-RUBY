...
require 'date'
module MundiApi
  # RecipientsAutomaticAnticipationSettingsResponse Model.
  class RecipientsAutomaticAnticipationSettingsResponse < BaseModel
    # Id
    # @return [String]
    attr_accessor :id
    ...
    def self.from_hash(hash)
      ...
      RecipientsAutomaticAnticipationSettingsResponse.new(id,
                                                          name,
                                                          email,
                                                          document,
                                                          description,
